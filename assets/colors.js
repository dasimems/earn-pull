export const primaryColor = {
  ...
  opacity100: "rgba(103, 58, 183, .1)",
  opacity200: "rgba(103, 58, 183, .2)",
  opacity300: "rgba(103, 58, 183, .3)",
  opacity400: "rgba(103, 58, 183, .4)",
  opacity500: "rgba(103, 58, 183, .5)",
  opacity600: "rgba(103, 58, 183, .6)",
  opacity700: "rgba(103, 58, 183, .7)",
  opacity800: "rgba(103, 58, 183, .8)",
  opacity900: "rgba(103, 58, 183, .9)"
};
